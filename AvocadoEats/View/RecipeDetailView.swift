...
struct RecipeDetailView: View {
    ...
    @State private var pulsate: Bool = false  // Used to pulsate for animation
    @Environment(\.presentationMode) var presentationMode  // Used to dismiss the sheet in popup
